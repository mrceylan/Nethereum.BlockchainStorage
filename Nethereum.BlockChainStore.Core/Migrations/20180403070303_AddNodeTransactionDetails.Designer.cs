...
namespace OpsICO.Core.Migrations
{
    ...
    [Migration("20180403070303_AddNodeTransactionDetails")]
    partial class AddNodeTransactionDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.Commitment", b =>
                {
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.IcoContract", b =>
                {
                    b.Property<int>("IcoContractID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("IcoContractID");

                    b.HasIndex("CampaignID")
                        .IsUnique();

                    b.ToTable("IcoContract");
                });

            modelBuilder.Entity("OpsICO.Core.Entities.IcoTokenRelation", b =>
                {
                    b.Property<int>("IcoTokenRelationID")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("IcoContractID");

                    b.Property<int>("TokenContractID");

                    b.Property<int>("TokenType");

                    b.HasKey("IcoTokenRelationID");

                    b.HasIndex("IcoContractID");

                    b.HasIndex("TokenContractID");

                    b.ToTable("IcoTokenRelation");
                });
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.NodeTransactionDetail", b =>
                {
                    b.Property<int>("NodeTransactionDetailId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("NodeTransactionDetailId");

                    b.HasIndex("NodeTransactionId");

                    b.ToTable("NodeTransactionDetail");
                });
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.Pricing", b =>
                {
                    ...
                    b.Property<double>("OpsPerCurrency");
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.TokenContract", b =>
                {
                    b.Property<int>("TokenContractID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("TokenContractID");

                    b.ToTable("TokenContract");
                });
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.IcoContract", b =>
                {
                    b.HasOne("OpsICO.Core.Entities.Campaign", "Campaign")
                        .WithOne("IcoContract")
                        .HasForeignKey("OpsICO.Core.Entities.IcoContract", "CampaignID")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("OpsICO.Core.Entities.IcoTokenRelation", b =>
                {
                    b.HasOne("OpsICO.Core.Entities.IcoContract", "IcoContract")
                        .WithMany("IcoTokenRelation")
                        .HasForeignKey("IcoContractID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("OpsICO.Core.Entities.TokenContract", "TokenContract")
                        .WithMany("IcoTokenRelation")
                        .HasForeignKey("TokenContractID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.NodeTransactionDetail", b =>
                {
                    b.HasOne("OpsICO.Core.Entities.NodeTransaction", "NodeTransaction")
                        .WithMany("NodeTransactionDetails")
            ...
            modelBuilder.Entity("OpsICO.Core.Entities.ReferenceDetail", b =>
                {
                    b.HasOne("OpsICO.Core.Entities.ApplicationUser", "NewUser")
                        .WithMany()
